                ...
                with Battery(scf) as Bat:
                    ...
                    while keep_flying:
                        ...
                        if uri == "radio://0/80/2M/E7E7E7E703":
                            ...
                            for k in range(len(params['radio://0/80/2M/E7E7E7E703'][0]['trace_x'])):
                                if  ((
                                        (Xpos-params['radio://0/80/2M/E7E7E7E703'][0]['trace_x'][k])**2
                                        +
                                        (Ypos-params['radio://0/80/2M/E7E7E7E703'][0]['trace_y'][k])**2
                                    )**(1/2)) > 0.8:
                        ...
                        if turning:
                            ...
                            if uri == "radio://0/80/2M/E7E7E7E703" or uri == "radio://0/70/2M/E7E7E7E704":
                                if left < 0.7:
                                    mc.stop()
                                    turning = False
                                    rate = 0
                            if uri == "radio://0/90/2M/E7E7E7E702":
                                if right < 0.7:
                                    mc.stop()
                                    turning = False
                                    rate = 0
                        ...
                        if up < 0.2 :
                            ...
                            if uri == "radio://0/80/2M/E7E7E7E703" or uri == "radio://0/70/2M/E7E7E7E704":
                                if left > 1.0: # 왼쪽 벽이 멀면
                                    if TT == False:
                                        rate, turning, trace = turn_L(90, mc, scf)
                                        velocity_x = 0
                                        # print(uri)
                                    
                                elif left <= 0.8: # 왼쪽 벽이 가까우면
                                    if TT == False:
