...
class Quadcopter():
    ...
    def __init__(self, pos, vel, angle, ang_vel, pos_ref, dt):
        ...
        # kt = 1e-7
        kt = 3.421e-10 # proportionality constant to convert motor rotational speed into thrust (T=kt*omega^2), N/(rpm)^2
        ...
        self.Ixx = 1.43e-5  # mass-moment of inertial about x-axis, kg-m^2
        self.Iyy = 1.43e-5  # mass-moment of inertial about y-axis, kg-m^2
        self.Izz = 1.43e-5 # mass-moment of inertial about z-axis, kg-m^2
